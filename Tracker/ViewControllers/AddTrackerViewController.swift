...
final class AddTrackerViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        titleTextField.snp.makeConstraints { make in
            make.height.equalTo(TrackerConstants.Layout.textFieldHeight)
        }
        optionsTableView.snp.makeConstraints { make in
            ...
            make.leading.trailing.equalToSuperview().inset(TrackerConstants.Layout.defaultSpacing)
            make.height.equalTo(options.count * Int(TrackerConstants.Layout.textFieldHeight))
        }
...
extension AddTrackerViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if collectionView == emojiCollectionView {
            ...
            selectedColor = TrackerConstants.colors[indexPath.item]
        }
